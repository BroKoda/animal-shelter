...
const Home = (): JSX.Element => {
  ...
  const { residents, news, fetchResidentsStatus, fetchNewsStatus } = useAppSelector((state) => state.home)
  ...
  return (
    <BaseLayout>
      <>
        {(fetchResidentsStatus === LoadingStatus.error || fetchNewsStatus === LoadingStatus.error) &&
          <Error/>
        }

        {(fetchResidentsStatus === LoadingStatus.loading || fetchNewsStatus === LoadingStatus.loading) &&
          <ProgressIndicator/>
        }

        {(fetchResidentsStatus === LoadingStatus.complete || fetchNewsStatus === LoadingStatus.complete) &&
